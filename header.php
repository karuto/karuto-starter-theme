...
<!--           <a href="<?php echo esc_url( home_url( '/' ) ); ?>" 
      ...
      <nav class="external-nav" role="navigation">
        <li class="external-item"><a href="http://www.mangatalk.net">漫言</a></li>
        <li class="external-item"><a href="http://www.douban.com/people/karu">豆瓣</a></li>
        <li class="external-item"><a href="<?php bloginfo('rss2_url'); ?>">订阅</a></li>
        <li class="external-item"><a href="mailto:iamkaruto@gmail.com">来信</a></li>
